...
pGZ_YBal_W1 <- table(dat_sim_w2_init[dat_sim_w2_init$R2==1,"G"],dat_sim_w2_init[dat_sim_w2_init$R2==1,"Z"])/n2.W1
pGZ_comp <- table(dat_sim_w2_init$G,dat_sim_w2_init$Z)/N
...
load(biopsy_adcat_twowavedat_120.RData)

dat_sim <- dat_sim_w2_init_w2_init
